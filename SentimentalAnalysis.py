        ...
        with audio_stream as source:
            ...
            while not stop_listening_punjabi:
                try:
                    ...
                    sentiment_label_punjabi.config(text=f"Sentiment: {sentiment.polarity} (Polarity), {sentiment.subjectivity} (Subjectivity)")
        ...
        with audio_stream as source:
            ...
            while not stop_listening_french:
                try:
                    ...
                    # Sentiment Analysis
                    sentiment = analyze_sentiment(text)
                    sentiment_label_french.config(text=f"Sentiment: {sentiment.polarity} (Polarity), {sentiment.subjectivity} (Subjectivity)")
...
sentiment_label_punjabi = tk.Label(root, text="Sentiment: ", bg="#f5f5f5", fg="#333", font=("Helvetica", 12))
sentiment_label_punjabi.grid(row=10, column=0, columnspan=2, padx=10, pady=5)
...
sentiment_label_french = tk.Label(root, text="Sentiment: ", bg="#f5f5f5", fg="#333", font=("Helvetica", 12))
sentiment_label_french.grid(row=10, column=2, columnspan=2, padx=10, pady=5)
